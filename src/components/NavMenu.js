    ...
    return (
      <header>
        <Navbar bg="light" expand="lg">
          <Container>
            <Navbar.Brand as={Link} to="/">HarvestHelper</Navbar.Brand>
  ...
  authenticatedView()
  {
    if (this.state.role === "Admin")
    {
      return (<Fragment>
        <Nav className="mr-auto">
          <Nav.Link as={Link} to="/">Home</Nav.Link>
          <Nav.Link as={Link} to={ApplicationPaths.EquipmentInventoryPath}>My EquipmentInventory</Nav.Link>
          <Nav.Link as={Link} to={ApplicationPaths.EquipmentPath}>Equipment</Nav.Link>
